    ...
    <Box m={4}>
      <form onSubmit={save}>
        ...
        >
          ...
          <FormHelperText>
            This name must be unique to all your lists. If you change the name
            of the list then the url will be updated as well. The list name
            cannot exceed {NAME_CHAR_LIMIT} characters.
          </FormHelperText>
          <FormErrorMessage>
